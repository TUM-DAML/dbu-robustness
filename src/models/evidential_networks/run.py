...
from src.models.evidential_networks.train import train
from src.models.evidential_networks.test import test
...
def run(
    ...
    ## Train model ##
    #################
    model = EvidentialN(input_dims=input_dims,
    ...
    model_path = f'{directory_model}/model-evn-{full_config_name}'
    ...
    result_path = f'{directory_results}/results-evn-{full_config_name}'
