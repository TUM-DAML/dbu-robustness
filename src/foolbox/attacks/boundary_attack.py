...
class BoundaryAttack(MinimizationAttack):
    ...
    def __init__(
        ...
        steps: int = 25000,             # default foolbox 25000
        ...
        lambda_alpha0: float = 0.01,  # for in data alpha0 is in [10, 100] (in: high, out:low), L2 distance is in [0,1]
        lambda_diffE: float = 0.05,   # diffE is in  [-32.45, -12.80] if alpha0=100 (in: low, out: high)
        lambda_distU: float = 3.0,    # distU is in [0.038, 0.3736] if alpha0=100 (in: low, out: high)
