    ...
    def __call__(  # type: ignore
        ...
        **kwargs: Any,
        ...
        for epsilon in real_epsilons:
            xp = self.run(model, x, criterion, epsilon=epsilon, loss_name=loss_name, data_type=data_type,**kwargs)
...
class MinimizationAttack(AttackWithDistance):
    ...
    def __call__(  # type: ignore
        ...
        **kwargs: Any,
        ...
        xp = self.run(model, x, criterion, early_stop=early_stop, loss_name=loss_name, data_type=data_type, punished_measure=punished_measure, **kwargs)
