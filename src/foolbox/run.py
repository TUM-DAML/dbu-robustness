...
from src.foolbox.test_attack import test_attack
...
def run(
    ...
    metrics = test_attack(model, id_test_loader, ood_test_loader, attack_name, attack_loss, punished_measure, start_data, magnitude, bounds, result_path)
